...
publicWidget.registry.TpSuggestedProductSlider = ProductRootWidget.extend(ProductsBlockMixins, {
    ...
    _initializeOWL: function () {
        ...
        $owlSlider.owlCarousel({ dots: false, margin: 15, stagePadding: 6, autoplay: true, autoplayTimeout: 3000, autoplayHoverPause: true, rewind: true, rtl: localization === 'rtl', responsive: responsiveParams});
