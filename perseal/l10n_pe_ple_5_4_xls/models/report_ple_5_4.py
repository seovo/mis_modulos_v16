...
class ReportReportPle054xlxs(models.AbstractModel):
    _name = 'report.report.ple.05.4'
    _inherit ='report.report_xlsx.abstract'
    _description = 'Report ple 5.4'
    ...
    def generate_xlsx_report(self, workbook, data, obj):
        ...
        ws.merge_range('B1:E1', 'FORMATO 5.4: LIBRO DIARIO DE FORMATO SIMPLIFICADO - DETALLE DE PLAN CONTABLE UTILIZADO', bold_right)
