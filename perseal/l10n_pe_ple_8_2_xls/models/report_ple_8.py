...
class Report08xlxs(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, obj):
        ...
        sheet.merge_range('A1:B1', u'FORMATO 8.2: "REGISTRO DE COMPRAS"', bold_right)
        ...
        for line in obj.line_ids:
            ...
            sheet.write(i, 3, line.document_payment_type_5, normal)
            sheet.write(i, 4, line.sequence_dua_12, normal)
            sheet.write(i, 5, line.dua_dsi_year_13, normal)
            sheet.write(i, 6, line.reference_dua_tax_14, normal)
            sheet.write(i, 7, "", normal)
            sheet.write(i, 8, line.supplier_doc_number_21, normal)
            sheet.write(i, 9, line.supplier_name_19, normal)
            sheet.write(i, 10, '0.00', normal)
            sheet.write(i, 11, '0.00', normal)
            sheet.write(i, 12, round(line.tax_base_8, 2) or '0.00', normal)
            sheet.write(i, 13, '0.00', normal)
            sheet.write(i, 14, '0.00', normal)
            sheet.write(i, 15, '0.00', normal)
            sheet.write(i, 16, round(line.tax_base_8, 2) or '0.00', normal)
            sheet.write(i, 17, '0.00', normal)
            sheet.write(i, 18, round(line.tax_amount_9, 2) or '0.00', normal)
            sheet.write(i, 19,round(line.total_amount_10, 2) or '0.00', normal)
            sheet.write(i, 20, "", normal)
            sheet.write(i, 21, "", normal)
            sheet.write(i, 22, "", normal)
            sheet.write(i, 23, line.currency_exchange_rate_17, normal)
            sheet.write(i, 24, "", normal)
            sheet.write(i, 25, "", normal)
            sheet.write(i, 26, "", normal)
            sheet.write(i, 27, "", normal)
            i += 1