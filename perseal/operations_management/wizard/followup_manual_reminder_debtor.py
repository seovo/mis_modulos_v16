...
class FollowupManualReminder(models.TransientModel):
    _name = 'account_followup.manual_reminder.debtor'
    ...
    email_recipient_ids = fields.Many2many(string="Extra Recipients", comodel_name='res.partner',
                                           relation='rel_followup_manual_reminder_debtor_res_partner')  # override
    ...
    def _compute_subject(self):
        for wizard in self:
            options = {
                ...
                'mail_template': self.env.ref("operations_management.email_template_followup_anka"),
            }
