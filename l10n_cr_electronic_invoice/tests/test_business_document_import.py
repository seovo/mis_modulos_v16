...
class TestBaseBusinessDocumentImport(TransactionCase):
    def test_match_partner(self):
        ...
        partner_dict = {"email": " deco.addict82@example.com"}
        res = bdio._match_partner(partner_dict, [], partner_type="customer")
    ...
    def test_match_product(self):
        ...
        res = bdio._match_product(product_dict, [], seller=self.env.ref("base.res_partner_2"))
        self.assertEqual(res, product1)
        raise_test = True
        try:
