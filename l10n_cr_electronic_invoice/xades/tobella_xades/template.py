...
def add_production_place(node, city=None, state=None, postal_code=None, country=None):
    signature_properties = node.find("etsi:SignedSignatureProperties", namespaces=NS_MAP)
    production_place = signature_properties.find("etsi:SignatureProductionPlace", namespaces=NS_MAP)
